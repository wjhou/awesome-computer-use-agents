...
```mermaid
flowchart LR
  Problem["Problem: Browser automation CLI for AI agents."] --> Value["Novelty: Its novelty is implementation availability: readers can..."]
  Value --> Surface["Framework: Repo language: Rust; license: Apache-2.0."]
  Surface --> Signal["Signal: GitHub stars: 25187."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    ...
    A2["Contribution: Browser automation CLI for AI agents."]
    A3["Signal: GitHub stars: 25187."]
  end
