...
- [Anonymization-Enhanced Privacy Protection for Mobile GUI Agents: Available but Invisible](../../papers/safety-and-security/anonymization-enhanced-privacy-protection-for-mobile-gui-agents-available-but-invisible.md) - shared mobile-agent focus.
