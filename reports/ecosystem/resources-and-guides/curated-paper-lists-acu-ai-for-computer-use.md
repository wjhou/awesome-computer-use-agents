...
```mermaid
flowchart LR
  Problem["Problem: Includes: Research papers Open source projects Commercial..."] --> Value["Novelty: Its novelty is meta-curation: it compresses a fast-moving..."]
  Value --> Surface["Framework: Coverage: Papers, projects, frameworks, tools"]
  Surface --> Signal["Signal: GitHub stars: 1639."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    A1["Novelty: Its novelty is meta-curation: it compresses a fast-moving..."]
    A2["Contribution: It contributes discovery value by gathering many adjacent..."]
    A3["Signal: GitHub stars: 1639."]
  end
...
- [OpenCUA: Open Foundations for Computer-Use Agents](../../papers/models-and-architectures/opencua-open-foundations-for-computer-use-agents.md) - paper-side context for the same capability cluster.
- [CUA-Suite: Expert Trajectories and Pixel-Precise Grounding for Computer-use Agents](../../papers/benchmarks-and-datasets/cua-suite-expert-trajectories-and-pixel-precise-grounding-for-computer-use-agents.md) - paper-side context for the same capability cluster.
