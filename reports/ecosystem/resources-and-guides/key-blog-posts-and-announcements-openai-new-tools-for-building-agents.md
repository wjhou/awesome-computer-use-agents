...
| Field | Detail |
| --- | --- |
| Repo entry | New tools for building agents |
| Actual target | [Blog](https://openai.com/index/new-tools-for-building-agents/) |
| Group | Resources & Guides |
| Category | Key Blog Posts & Announcements / OpenAI |
| Source location | `resources/README.md:85` |
...
- [Building Browser Agents with MultiOn](tutorials-and-guides-getting-started-building-browser-agents-with-multion.md) - neighboring ecosystem entry in the same local cluster.
