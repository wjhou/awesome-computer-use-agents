...
```mermaid
flowchart LR
  Problem["Problem: Collection of AI agent papers updated biweekly."] --> Value["Novelty: Its novelty is meta-curation: it compresses a fast-moving..."]
  Value --> Surface["Framework: Coverage: General AI agents"]
  Surface --> Signal["Signal: GitHub stars: 1217."]
