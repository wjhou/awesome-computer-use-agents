...
| Field | Detail |
| --- | --- |
| Repo entry | Claude can now use computers |
| Actual target | [Blog](https://www.anthropic.com/news/claude-computer-use-ga) |
| Group | Resources & Guides |
| Category | Key Blog Posts & Announcements / Anthropic |
| Source location | `resources/README.md:77` |
...
flowchart LR
  ...
  Surface --> Signal["Signal: Resource provenance: unspecified source, Mar 2025."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    ...
    A3["Signal: Resource provenance: unspecified source, Mar 2025."]
  end
...
Anthropic announcement or blog post tracked in the repository's resource list.
...
- Resource provenance: unspecified source, Mar 2025.
