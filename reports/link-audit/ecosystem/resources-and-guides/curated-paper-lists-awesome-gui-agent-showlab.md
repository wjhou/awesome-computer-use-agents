...
```mermaid
flowchart LR
  Problem["Problem: Curated list for multi-modal GUI agents including: Models..."] --> Value["Novelty: Its novelty is meta-curation: it compresses a fast-moving..."]
  Value --> Surface["Framework: Coverage: Multi-modal GUI agents"]
  Surface --> Signal["Signal: GitHub stars: 1149."]
