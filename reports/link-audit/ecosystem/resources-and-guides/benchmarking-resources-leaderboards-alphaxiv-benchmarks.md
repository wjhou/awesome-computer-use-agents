...
flowchart LR
  ...
  Value --> Surface["Framework: Platform: alphaXiv Benchmarks"]
  Surface --> Signal["Signal: Benchmark website, leaderboard, or evaluation resource..."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    ...
    A3["Signal: Benchmark website, leaderboard, or evaluation resource..."]
  end
