...
```mermaid
flowchart LR
  Problem["Problem: External guide or tutorial relevant to computer-use agents."] --> Value["Novelty: Its novelty is interpretation: it helps readers compare..."]
  Value --> Surface["Framework: Resolved target..."]
  Surface --> Signal["Signal: Audit-time page title: OmniParser: Vision Based GUI Agent."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    ...
    A2["Contribution: External guide or tutorial relevant to computer-use agents."]
    A3["Signal: Audit-time page title: OmniParser: Vision Based GUI Agent."]
  end
