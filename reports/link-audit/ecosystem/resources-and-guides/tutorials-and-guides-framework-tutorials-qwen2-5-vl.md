...
flowchart LR
  ...
  Value --> Surface["Framework: External guide or tutorial relevant to computer-use agents."]
  Surface --> Signal["Signal: External guide or tutorial relevant to computer-use agents."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    ...
    A3["Signal: External guide or tutorial relevant to computer-use agents."]
  end
