...
```mermaid
flowchart LR
  Problem["Problem: Latest papers and datasets on mobile and PC GUI agents."] --> Value["Novelty: Its novelty is meta-curation: it compresses a fast-moving..."]
  Value --> Surface["Framework: Coverage: Mobile & PC GUI agents"]
  Surface --> Signal["Signal: GitHub stars: 154."]
