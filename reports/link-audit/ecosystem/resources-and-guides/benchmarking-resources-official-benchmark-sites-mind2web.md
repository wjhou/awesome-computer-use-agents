...
flowchart LR
  ...
  Value --> Surface["Framework: Resolved target: https://osu-nlp-group.github.io/Mind2Web/."]
  Surface --> Signal["Signal: Audit-time page title: Mind2Web."]
...
flowchart TB
  subgraph Adds["What This Entry Adds"]
    ...
    A3["Signal: Audit-time page title: Mind2Web."]
  end
